module github.com/Mouhamadou305/splunk-sli-provider
...
require (
	...
	github.com/prometheus/common v0.41.0 // pin to v0.32.1; must be the same as alertmanager
...
require (
	...
	github.com/splunk/go-dependencies v1.0.4 // indirect
	github.com/splunk/splunk-cloud-sdk-go v1.11.1 // indirect
